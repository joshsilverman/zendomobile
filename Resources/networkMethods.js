	...
	// if (Ti.App.data != null) {
		// for ( i in Ti.App.data ) {
			// if (Ti.App.data[i].tag.id == element) {					
				// for (n in Ti.App.data[i].tag.documents) {
					// // if ((n % 2) == 0) {
						// // notesRows.push(createNoteRow(Ti.App.data[i].tag.documents[n].name, Ti.App.data[i].tag.documents[n].id, Ti.App.data[i].tag.documents[n].tag_id, Ti.App.data[i].tag.documents[n].userships[0].push_enabled, true));	
					// // } else {
						// // notesRows.push(createNoteRow(Ti.App.data[i].tag.documents[n].name, Ti.App.data[i].tag.documents[n].id, Ti.App.data[i].tag.documents[n].tag_id, Ti.App.data[i].tag.documents[n].userships[0].push_enabled, false));
					// // }
					// notesRows.push(createNoteRow(Ti.App.data[i].tag.documents[n].name, Ti.App.data[i].tag.documents[n].id, Ti.App.data[i].tag.documents[n].tag_id, Ti.App.data[i].tag.documents[n].userships[0].push_enabled));
				// }
			// }
...
// function getPublicDocs(element){
	...
	// // } else {
		...
		// xhr.onload = function() {
			...
			// for ( i in foldersData ) {
				// // if ((n % 2) == 0) {
					// // notesRows.push(createNoteRow(foldersData[i].document.name, foldersData[i].document.id, foldersData[i].document.tag_id, false, true));	
				// // } else {
					// // notesRows.push(createNoteRow(foldersData[i].document.name, foldersData[i].document.id, foldersData[i].document.tag_id, false, false));
				// // }
				// notesRows.push(createNoteRow(foldersData[i].document.name, foldersData[i].document.id, foldersData[i].document.tag_id, false));
			// }	
			// if ( notesRows.length >= 1 ) {
				// var newWin = Ti.UI.createWindow({
					// url : "notes.js",
